...
\item Control system electronics cost 27.5kgCO${_2}$/kg and therefore should be carefully designed. However increasing the resolution of the control system to allow each panel to be independently actuated only increases the emission factor by 1.5g${_2}$/kWh.
