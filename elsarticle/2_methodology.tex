...
Air compressor, screw type, 0.75kW & \textcolor{red}{NA} ${\mathrm{kg/m^2_{facade}}}$\\
\hline
\end{tabular}
...
\item[2. Scope] The scope of the assessment is sumarised in Figure \ref{fig:BOS}. We analyse the GWP of manufacture, dynamic actuation, maintenance, disposal and the GWP savings through adaptive shading. \\

\textcolor{red}{The system boundary includes...(transport etc)}
