...
The life cycle assessment is performed in three stages 1) goal, 2) scope definition, and 3) assessment.
...
\begin{equation}
EF=\frac{GWP}{\mathrm{G}} \textcolor{magenta}{maybe also: [\frac{kg CO2-eq.}{kWh}]}
\label{eq:EF}
\end{equation}
...
Average Solar Radiation               & 966kWh/m$^2$/year                              \\
                              &                                                \\
\textbf{Maintenance}          &                                                \\
