...
\begin{abstract}
Text \\
\textcolor{cyan}{@Zoltan, we are thinking about possibly deleting the blue text as the introduction is quite large and we need to simplify it. Could you comment on this as well}
\end{abstract}
